    ...
    namespace Simulation
    {
        ...
        void simulation_dji_a3_adapter::tick()
        {
            ...
            if (count++ % 50 == 0 && !assiant_online) {
                ...
                std::cout << "Try to reconnect A3 assiant " << std::endl;
                c_root.connect(con);
                                                             ...
                                                             message_ptr msg)
        {
            ...
            aircraft->set_internal_state("main_wing_0/flap_0", (pwm[2] / 100 - 0.5) / 5);
            aircraft->set_internal_state("main_wing_0/flap_1", (0.5 - pwm[2] / 100) / 5);
            aircraft->set_internal_state("horizon_wing_0/flap_0", 0.5 - pwm[3] / 100);
            aircraft->set_internal_state("vertical_wing_0/flap_0", pwm[4] / 100 - 0.5);
        }
