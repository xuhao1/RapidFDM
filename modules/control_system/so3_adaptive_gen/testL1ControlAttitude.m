...
attcon.RollCtrl = L1ControllerUpdateParams(attcon.RollCtrl,6.0,1.0,30,1000,3,2.5,3,0.02);
attcon.PitchCtrl = L1ControllerUpdateParams(attcon.PitchCtrl,6.0,1.0,30,1000,3,2.5,3,0.02);
