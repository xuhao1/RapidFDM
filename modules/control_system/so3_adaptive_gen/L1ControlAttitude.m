...
if quat_control_sp.yaw_sp_is_rate
    [obj.YawCtrl,u_yaw] = L1AdaptiveControl1st(dt,obj.YawCtrl,x_real_yaw,quat_control_sp.yaw_rate);
else
    [obj.YawCtrl,u_yaw] = L1AdaptiveControl2nd(dt,obj.YawCtrl,x_real_yaw,0);
end
obj.quat_sp = quat_sp;
obj.quat = sys_state.quat;
obj.u = [u_roll,u_pitch,u_yaw];
end